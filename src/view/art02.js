...
const accordionData = [
  {
    ...
    content: (
      <div className="flex flex-col lg:flex-row items-center bg-black text-white min-h-[300px] px-6 lg:px-16 py-10 gap-6 ">
      <div className="w-full lg:w-[400px] text-center lg:text-left">
        <h1 className="text-[32px] lg:text-[50px] font-bold">THE 5TH ALBUM</h1>
      </div>
...
<div class="flex justify-center mt-6 space-x-4 sm:flex hidden">
  ...
  <div class="relative pb-1">
    <button class="px-4 py-2 text-gray-400 hover:text-white hover:bg-gray-700 transition">
      2
    </button>
  </div>
