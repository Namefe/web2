  ...
  return (
    <>
        <section className="inline-block w-full min-h-screen px-10 py-12 text-black ">
          <div className='sec7txt text-[40px] sm:text-[50px] font-bold'>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-2">
              ...
              <img className='w-full h-full object-cover' src={process.env.PUBLIC_URL + '/sec7_02bg.png'}/>
                ...
                <div className='absolute bottom-4 left-4 text-white'>
                  <div className='inline-block  group'>
                    <span className="inline-block relative text-[30px] sm:text-[40px] font-bold">KWANGYA 119
                    <span className="absolute left-0 -bottom-0 h-[2px] w-0 bg-white transition-all duration-300 group-hover:w-full"></span>
                    </span></div>
                  <img className='inline-block mb-3' src={process.env.PUBLIC_URL + '/화살표.png'}/>
              ...
              <div className='relative h-[250px] group hover: cursor-pointer'>
                <img className='w-full h-full object-cover' src={process.env.PUBLIC_URL + '/sec7_03.png'}/>
                  <div className='absolute bottom-4 left-4 text-white '>
                  <div className='inline-block  group'>
                    <span className="inline-block relative text-[30px] sm:text-[40px] font-bold">SMTOWN 30
                    <span className="absolute left-0 -bottom-0 h-[2px] w-0 bg-white transition-all duration-300 group-hover:w-full"></span>
                    </span></div>
                    <img className='inline-block mb-3' src={process.env.PUBLIC_URL + '/화살표.png'}/>
