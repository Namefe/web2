...
const View01 = () => {
  return (
    <section className="relative w-full  min-h-screen bg-black  overflow-hidden">
      <div className="relative w-full h-screen z-10">
        <div className="absolute top-[40%] left-[5%] lg:top-[65%] lg:left-[8%] -translate-x-1/2 -translate-y-1/2 scale-[0.5] lg:scale-[1] z-50">
          <div className="relative inline-block overflow-hidden">
            <img src={process.env.PUBLIC_URL + "/1.png"} className="relative z-10 block pointer-events-none" />
            <div
      ...
      <div className="sm:text-left text-center absolute w-full font-bold text-white  bottom-9">
        <div className="mb-20 px-36">
      ...
      <div className="relative">
        <div className="absolute lg:bottom-[50px] lg:left-[50px] text-xs sm:text-[12px] text-white hidden 2xl:block">
          Introduction
        </div>
